...
<body>
    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                {{-- <p class="text-center">
                    <a href="{{ route('volt.dashboard') }}" class="d-flex align-items-center justify-content-center">
                            ...
                            <form class="form-horizontal mt-4" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" placeholder="Alamat Email" name="email" id="email" value="{{ old('email') }}" autofocus required>
                                        @if ($errors->has('email'))
                                            <div class="invalid-feedback">
                                                Sila masukkan email dan kata laluan yang sepadan.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="Kata Laluan" name="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="{{ route('password.request') }}"
                                                class="small text-right">Lupa kata laluan?</a></div>
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800">Log masuk</button>
                                </div>
                            </form>
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Belum mempunyai akaun?
                                    <a href="{{ route('register') }}" class="fw-bold">Daftar Akaun</a>
                                </span>
                            </div>
                        </div>
                    </div>
