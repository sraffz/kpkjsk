                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Daftar Akaun </h1>
                            </div>
                             <form class="form-horizontal mt-4" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="email" type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Alamat Email" name="email" value="{{ old('email') }}" required autofocus>
                                        @if ($errors->has('email'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('email') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" placeholder="Kata Laluan" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}"
                                    ...
                                    <!-- Form -->
                                    <div class="form-group mb-4">
                                        <label for="confirm_password">Sah Kata Laluan</label>
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon2">
                                                <svg class="icon icon-xs text-gray-600" fill="currentColor"
                                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <input id="confirm_password" type="password" class="form-control {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}"
                                                name="password_confirmation" required placeholder="Sah Kata Laluan">
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="{{ route('login') }}" class="fw-bold">Log masuk</a>
                                </span>
                            </div>
                        </div>
                    </div>
