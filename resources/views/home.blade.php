@extends('layouts.app', ['page' => 'halamanUtama'])
...
@section('content')
    <div class="py-4">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ url('permohonan-baru') }}">
                    <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="card-body">
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5"> Permohonan Jawatan</h2>
                                <h3 class="mb-1">{{ $bil_jawatan_dimohon }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0"> Permohonan Jawatan</h2>
                                <h3 class="fw-extrabold mb-2">{{ $bil_jawatan_dimohon }}</h3>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Jawatan Diluluskan</h2>
                                <h3 class="mb-1">{{ $bil_jawatan_lulus }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Jawatan Diluluskan</h2>
                                <h3 class="fw-extrabold mb-2">{{ $bil_jawatan_lulus }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                                ...
                                <div class="d-sm-none">
                                    <h2 class="h5">Dalam Tindakan</h2>
                                    <h3 class="fw-extrabold mb-1">{{ $bil_tindakan }}</h3>
                                </div>
                            </div>
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                                    <h2 class="h6 text-gray-400 mb-0">Dalam Tindakan</h2>
                                    <h3 class="fw-extrabold mb-2">{{ $bil_tindakan }}</h3>
                                </div>
    ...
    <div class="row">
        <div class="col-12 col-xl-12 mb-9">
            <div class="row">
                {{-- <div class="col-12 mb-4">
                <div class="card border-0 shadow">
