                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5"> Permohonan</h2>
                                <h3 class="mb-1">50</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0"> Permohonan</h2>
                                <h3 class="fw-extrabold mb-2">50</h3>
                            </div>
                            <small class="text-gray-500">
                                Jan - {{ \Carbon\Carbon::now()->format('M') }}
                            </small>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Permohonan Diluluskan</h2>
                                <h3 class="mb-1">$43,594</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Permohonan Diluluskan</h2>
