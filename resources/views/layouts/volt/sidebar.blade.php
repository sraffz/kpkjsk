    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                ...
                {{-- <a href="{{ url('/volt-1') }}" class="nav-link d-flex align-items-center"> --}}
            ...
            <li class="nav-item ">
                ...
                <div class="multi-level collapse {{ $page == 'table' ? ' show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ Request::routeIs('volt.components.*') ? 'show' : '' }}" role="list" id="submenu-components" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
