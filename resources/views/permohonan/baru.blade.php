        ...
        <div class="col-12">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">Butiran Permohonan</h2>
                 <form method="POST"  action="{{ route('simpan-permohonan-baru') }}" class="form-control">
                    {{ csrf_field() }}
                     <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dynamicAddRemove">
                            ...
                            <tr>
                                <td>
                                    <select class="form-select mb-0 select2-bs5" name="addMoreInputFields[0][jawatan]"
                                ...
                                <td>
                                    <select class="form-select mb-0 select2-bs5" name="addMoreInputFields[0][gred]"
    ...
    <script type="text/javascript">
        ...
        $("#dynamic-ar").click(function() {
            ...
            $("#dynamicAddRemove").append(
                '<tr><td><select class="form-select mb-0 select2-bs5" name="addMoreInputFields['
                    + i +'][jawatan]"aria-label="Pilih Jawatan" required> <option value="">Jawatan</option> @foreach ($skim as $skims) <option value="{{ $skims->id }}">{{ $skims->diskripsi }}</option>@endforeach</select></td> <td> <select class="form-select mb-0 select2-bs5" name="addMoreInputFields['
