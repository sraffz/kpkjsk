@extends('layouts.volt.app', ['page' => 'settings'])
                ...
                <div class="col-12 mb-4">
                    <div class="card shadow border-0 text-center p-0">
                        ...
                        <div class="card-body pb-5">
                            <img src="{{ asset('volt/assets/img/team/profile-picture-1.jpg') }}"
                ...
                <div class="col-12">
                    <div class="card card-body border-0 shadow mb-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                <!-- Avatar -->
                                <img class="rounded avatar-xl" src="{{ asset('volt/assets/img/team/profile-picture-3.jpg') }}"
                                    alt="change avatar">
                            </div>
                ...
                <div class="col-12">
                    <div class="card card-body border-0 shadow">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                <!-- Avatar -->
                                <img class="rounded avatar-xl" src="{{ asset('volt/assets/img/profile-cover.jpg') }}" alt="change cover">
                            </div>
                            <div class="file-field">
                                <div class="d-flex justify-content-xl-center ms-xl-3">
                                    <div class="d-flex">
