@extends('layouts.volt.app', ['page' => 'table'])
                    ...
                    <tbody>
                            ...
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/united-states-of-america.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/canada.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/united-kingdom.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/france.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/japan.svg') }}">
                        ...
                        <tr>
                            <td class="border-0">
                                <a href="#" class="d-flex align-items-center">
                                    <img class="me-2 image image-small rounded-circle" alt="Image placeholder"
                                        src="{{ asset('volt/assets/img/flags/germany.svg') }}">
